...
export default function OrderDashboard() {
    ...
    // ✅ FIX: jangan panggil refresh() di useEffect
    useEffect(() => {
        let cancelled = false;
        ...
        <div className="min-h-screen bg-[#070A12] text-white flex items-center justify-center">
            <div className="w-full max-w-4xl px-6 py-12">
                ...
                <div className="mb-12 text-center">
                    <p className="text-xs uppercase tracking-widest text-white/40">Connectivity Test App</p>

                    <h1 className="mt-4 text-5xl font-bold tracking-tight">Order Dashboard</h1>

                    <p className="mt-3 text-white/60">Frontend ↔ Backend ↔ Database</p>
            ...
            <span className={cx("rounded-full border px-4 py-1 text-sm font-semibold", healthTone)}>
              HEALTH: {health}
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-xl backdrop-blur-xl">
                    <h2 className="mb-6 text-lg font-semibold text-white/90 text-center">Backend / DB Status</h2>
                    ...
                    <div className="space-y-4 text-sm text-center">
                        ...
                        <div className="text-white/50">Endpoint: GET /actuator/health</div>
